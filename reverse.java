...
public class reverse {
    ...
    public static void printn(int arr[]) {
        // to carry the loop of the arr[] that is going in .length catogery
        for (int i = 0; i < arr.length; i++) {
            System.out.println(arr[i] + arr[i + 1] + " ");
            i++; // it is in the way of formating in the place
            i--; // is it the formating way of an arr[] in the basic of the matter
        }
        System.out.println(); //
    }
